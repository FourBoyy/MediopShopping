...
@section('title', 'Blog')
@section('head', 'Blog')
@section('description', 'Manage blog posts in the MediopShopping admin panel.')
@section('body')
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="hpanel blog-box responsive-mg-b-30">
                        ...
                        <div class="panel-body blog-pra">
                            ...
                            <p>
                                There are many variations of the passages of Lorem Ipsum onece available, but the majority

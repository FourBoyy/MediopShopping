...
@section('head','Category List')
@section('description','Add, edit,delete, and manage categories in the Mediopshopping admin panel. View category details and manage their properties.')
@section('body')
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="{{ route('admin.categories.add') }}">Add Category</a>
                            </div>
                            <table>
                                <tr>
                                    <th>Image</th>

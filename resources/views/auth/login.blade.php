    ...
    <div class="bg-white max-w-md w-full rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] p-8">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-5">
            ...
            <div>
                <div class="relative">
                    ...
                    <button type="button" id="toggle-password" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 hover:text-[#18b2ab] transition">
            ...
            <div class="flex items-center justify-end">
                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" class="text-sm font-semibold text-primary-dark hover:underline">
                        Quên mật khẩu?
                    </a>
                @endif
            </div>

            <button type="submit" class="w-full btn-gradient text-white font-semibold py-3 rounded-full shadow-md transition duration-300">
                Đăng nhập
            </button>
        </form>
        ...
        <div class="mt-8">
            ...
            <div class="mt-6 flex justify-center gap-4">
                <a href="#" class="w-12 h-12 rounded-full flex items-center justify-center border border-gray-200 hover:bg-gray-50 transition shadow-sm">
                    <img src="https://www.svgrepo.com/show/475656/google-color.svg" class="w-6 h-6" alt="Google">
                </a>
                <a href="#" class="w-12 h-12 rounded-full flex items-center justify-center bg-[#1877F2] hover:bg-[#166fe5] transition shadow-sm">
                    <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
                </a>
            </div>
        </div>
